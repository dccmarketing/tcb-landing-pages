...
add_action( 'customize_register', 'tcb_landing_register_panels' );
add_action( 'customize_register', 'tcb_landing_register_sections' );
add_action( 'customize_register', 'tcb_landing_register_fields' );

// Output custom CSS to live site
add_action( 'wp_head', 'tcb_landing_header_output' );

// Enqueue live preview javascript in Theme Customizer admin screen
add_action( 'customize_preview_init', 'tcb_landing_live_preview' );

// Enqueue scripts for the customizer controls
add_action( 'customize_controls_enqueue_scripts', 'tcb_landing_control_scripts' );
 ...
 */
function tcb_landing_register_panels( $wp_customize ) {
 ...
 * @param 		WP_Customize_Manager 		$wp_customize 		Theme Customizer object.
 */
function tcb_landing_register_sections( $wp_customize ) {
 ...
 * @param 		WP_Customize_Manager 		$wp_customize 		Theme Customizer object.
 */
function tcb_landing_register_fields( $wp_customize ) {
 ...
 */
function tcb_landing_generate_css( $selector, $style, $mod_name, $prefix = '', $postfix = '', $echo = true ) {
 ...
 * @since 		1.0.0
 */
function tcb_landing_header_output() {
 ...
 * @since 		1.0.0
 */
function tcb_landing_live_preview() {
 ...
 * @since 		1.0.0
 */
function tcb_landing_control_scripts() {
 ...
 */
function tcb_landing_states_of_country_callback( $control ) {
...
} // tcb_landing_states_of_country_callback()
 ...
 */
function tcb_landing_custom_countries( $country ) {

	$countries = array( 'US', 'CA', 'AU' );

	return in_array( $country, $countries );

} // tcb_landing_custom_countries()
 ...
 */
function tcb_landing_country_list( $country = '' ) {
